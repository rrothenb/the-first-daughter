...
- I may need to maintain multiple timelines and pick and choose from them.  I don't want to forget where I made a deliberate decision to deviate or switch

Remember to remove stuff from this list that's already been done or is no longer applicable
...
Ultimately, this vault is completely mine and should probably consist mostly of my words in a way that makes sense to me.  The only thing needed here relative to Claude is that everything here needs to be available to Claude so he knows what I've been working on.

Think about whether or not I really need to link stuff, as I can always view the unlinked mentions
* If I don't, then they don't show up in the graph

There's probably no substitute for methodically reviewing each and every chat for stuff worth recording in Obsidian.  Claude is great for bouncing ideas and getting research, but I don't think it's a good tool for organizing as I need it to fit my particular needs, not some general notion of what seems like a good organization.  It does a good job of making things look organized, but that's really not what I need.  I should probably delete nearly all these notes and start all over, except for this.

It might be the case that this repo is read only for Claude.  Only my words or source material should go in here.  I should rephrase anything that I think Claude told me that I think is worth remembering.
...
Probably want no more than one deep folder structure
